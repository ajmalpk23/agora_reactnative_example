...
//     //   };
//     return(
//        videocall  ?  <Uikit rtcProps={rtc} callbacks={callback}   /> : <View style={{backgroundColor:'#fff',alignItems:'center',justifyContent:'center',height:'100%',width:'100%'}}><Text>Call End</Text></View>
//     )
